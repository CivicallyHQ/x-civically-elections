# Civically Elections Extension

This is a Discourse plugin built for [Civically](https://civically.io). It is an extension of the [Discourse Elections plugin](https://meta.discourse.org/t/elections-plugin/68521).
